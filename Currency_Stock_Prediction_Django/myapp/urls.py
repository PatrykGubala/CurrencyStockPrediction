...
from myapp.controllers.currency_pairs_data_controller import get_all_currency_pair_data, load_currency_pair_data, get_latest_currency_pair_data, get_percentage_change_for_pair
...
urlpatterns = [
    ...
    path('currency-pairs/data', get_all_currency_pair_data, name='get_all_currency_pair_data'),
    path('currency-pairs/data/load_currency_pair_data', load_currency_pair_data, name='load_currency_pair_data'),
    path('currency-pairs/data/<int:pair_id>/latest', get_latest_currency_pair_data,
         name='get_latest_currency_pair_data'),
    path('currency-pairs/data/<int:pair_id>/change', get_percentage_change_for_pair,
         name='get_percentage_change_for_pair'),
