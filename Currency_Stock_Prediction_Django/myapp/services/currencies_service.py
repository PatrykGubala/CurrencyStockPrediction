...
class CurrenciesService:
    ...
    def get_all_currencies_dto(self) -> List[dict]:
        currencies = self.currencies_repo.get_available_currencies()
    ...
    def convert_currency(self, amount: float, from_currency_code: str, to_currency_code: str) -> Tuple[
        ...
        try:
            from_currency = self.currencies_repo.get_currency_by_code(from_currency_code.upper())
            to_currency = self.currencies_repo.get_currency_by_code(to_currency_code.upper())
