...
@swagger_auto_schema(method='POST',operation_description="Load hourly stock data for symbol",request_body=openapi.Schema(type=openapi.TYPE_OBJECT,properties={'stock_symbol': openapi.Schema(type=openapi.TYPE_STRING),'start_date': openapi.Schema(type=openapi.TYPE_STRING),'end_date': openapi.Schema(type=openapi.TYPE_STRING)}),responses={202:"Data load initiated"})
@api_view(['POST'])
...
@swagger_auto_schema(method='GET',operation_description="Get tlatest stock data for symbol",responses={200: openapi.Schema(type=openapi.TYPE_OBJECT,properties={'stock_symbol': openapi.Schema(type=openapi.TYPE_STRING),'timestamp': openapi.Schema(type=openapi.TYPE_STRING),'open_price': openapi.Schema(type=openapi.TYPE_STRING),'high_price': openapi.Schema(type=openapi.TYPE_STRING),'low_price': openapi.Schema(type=openapi.TYPE_STRING),'close_price': openapi.Schema(type=openapi.TYPE_STRING),'volume': openapi.Schema(type=openapi.TYPE_STRING)}),404:"Not found"})
@api_view(['GET'])
...
@swagger_auto_schema(
    method='GET',
    operation_description="Get aggregated stock data",
    manual_parameters=[openapi.Parameter('frequency', openapi.IN_QUERY, description="daily or hourly", type=openapi.TYPE_STRING),
                       openapi.Parameter('range', openapi.IN_QUERY, description="all_data or last_month", type=openapi.TYPE_STRING)],
    responses={200: openapi.Schema(type=openapi.TYPE_OBJECT,
                                   properties={'data': openapi.Schema(type=openapi.TYPE_ARRAY,items=openapi.Schema(type=openapi.TYPE_OBJECT,properties={'timestamp': openapi.Schema(type=openapi.TYPE_STRING),
                                                                                                                               'open_price': openapi.Schema(type=openapi.TYPE_STRING),
                                                                                                                               'high_price': openapi.Schema(type=openapi.TYPE_STRING),
                                                                                                                               'low_price': openapi.Schema(type=openapi.TYPE_STRING),
                                                                                                                               'close_price': openapi.Schema(type=openapi.TYPE_STRING),
                                                                                                                               'volume': openapi.Schema(type=openapi.TYPE_STRING)}))}),404:"Not found"})
@api_view(['GET'])
...
@swagger_auto_schema(
    method='GET',
    operation_description="Get monthly percentage change for stock symbol",
    responses={
        200: openapi.Schema(
...
def get_stocks_monthly_percentage_change(request, stock_symbol):
    ...
    if not monthly_change:
        return Response({"error": "No monthly change data for stock."}, status=status.HTTP_404_NOT_FOUND)
    return Response(monthly_change, status=status.HTTP_200_OK)


@swagger_auto_schema(
    method='GET',
    operation_description="Get weekly, monthly and yearly percentage changes for stock",
    responses={
        200: openapi.Schema(
            type=openapi.TYPE_OBJECT,
            properties={
...
def get_weekly_monthly_yearly_change(request, stock_symbol):
    ...
    if not changes:
        return Response({"error": "No data found for stock"}, status=status.HTTP_404_NOT_FOUND)
